...
def get_data():
    ...
    data_list = list()
    data_list.append(text.text_to_sequence(test0, hp.text_cleaners))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--step', type=int, default=120000)
    ...
    for i, phn in enumerate(data_list):
        mel_path = "results/"+str(args.step)+"_"+str(i)+".mel"
