...
class FastSpeech2(nn.Module):
    ...
    def forward(self,
        ...
        e_predictions, log_d_predictions, 
        d_rounded, mel_lens, mel_masks) = self.variance_adaptor(output,
            src_masks,
            mel_masks,
            max_mel_len,
            p_targets,
        ...
        return output, postnet_output, p_predictions, e_predictions, log_d_predictions, d_rounded, src_masks, mel_masks, src_lens, mel_lens